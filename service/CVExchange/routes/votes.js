...
router.post('/ratepost', auth, async (req, res) => {
    try {
        ...
        const [searchResults] = await req.database.query(search_query, search_params)
...
router.post('/ratecomment', auth, async (req, res) => {
    try {
        ...
        const [accResults] = await req.database.query(acc_query, acc_params)
        ...
        await req.database.query(comment_query, comment_params)
